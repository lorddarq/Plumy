      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <a href="https://github.com/lorddarq/Plumy/releases/latest" className="p-8 bg-white border border-nordic-gray-200 rounded-lg hover:border-nordic-blue hover:shadow-md transition-all group">
