...
const IPC_INVOKE_CHANNELS = [
  ...
  'agent-runtime/resolve-managed-workspace',
  'agent-runtime/prepare-execution',
  'agent-runtime/confirm-start',
  ...
  'agent-runtime/sessions/respond',
  'agent-runtime/sessions/resume',
  'agent-runtime/sessions/start',
  'agent-runtime/sessions/start-goal-node',
  'agent-runtime/sessions/steer',
